...
> unedited, because a pre-registration revised after the results are in is not a
> pre-registration. Its results are in [RESULTS_WORLD2.md](RESULTS_WORLD2.md),
> and they were forbidden by arithmetic rather than by tuning.
