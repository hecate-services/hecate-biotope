...
| **14** | **bare ground comes back from what is AROUND it**: `ground_seed` deleted, the floor is a share of the mean stock of the neighbouring cells at a swept `recolonise_pct` (`A.5`, targets `A.2` and `G.4`) | _running_ [preregistration](PREREGISTRATION_WORLD14.md) |
