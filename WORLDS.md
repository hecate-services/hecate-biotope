...
| **18** | **an act is TISSUE**: an output is charged by its wiring at a swept `act_cost`, so a creature that can do four things pays more than one that can do none (`H.7`) | _running_ [preregistration](PREREGISTRATION_WORLD18.md) |
